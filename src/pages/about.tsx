  ...
  return (
    <Layout meta={meta}>
      ...
      <p>
        ...
        technologies, working with different people to solve companies issues
        &amp; people needs.
      </p>
      <p>
        I believe in open-source and collaboration over competition, also I love
        sharing my knowledge and experience with others.
      </p>
      <h3>Experience</h3>
      <p>
